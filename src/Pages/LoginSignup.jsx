    ...
    <div className='h-[85vh] w-full bg-[#fce3fe] pt-[30px]'>
      <div className='w-[580px] h-[500px] bg-white m-auto px-4 py-6 shadow-lg shadow-zinc-500/50 rounded-2xl mt-[5vh]'>
        ...
        <div className='  mt-2 gap-10 flex flex-col '  >
          <input className='h-10 w-full pl-2 border-1 text-[#5c5c5c]  text-md border-2 ' type="text" placeholder='Your Name' />
          <input className='h-10 w-full pl-2 border-1 text-[#5c5c5c]  text-md border-2' type="email" placeholder='Email Adress' />
          <input className='h-10 w-full  pl-2 border-1 text-[#5c5c5c] text-md border-2' type="password" placeholder='Password' />
